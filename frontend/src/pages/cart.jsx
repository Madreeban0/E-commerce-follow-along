...
const Cart = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:8000/api/v2/product/cartproducts?email=${'reebanaustrive@gmail.com'}`)
          .then((res) => {
            if (!res.ok) {
            ...
            <div className='w-full h-full justify-center items-center flex'>
                <div className='w-full md:w-4/5 lg:w-4/6 2xl:w-2/3 h-full border-l border-r border-neutral-300 flex flex-col'>
                    ...
                    <div className='w-full p-4 flex justify-end'>
                      <button
                      onClick={handlePlaceOrder} className='bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600'>
                        Place Order
                      </button>
                    </div>
                </div>
